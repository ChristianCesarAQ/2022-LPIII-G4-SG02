...
public class TestHerencia {
    ...
    public static void main(String[] args) {
        Asalariados as1 = new Asalariados("Geral", 24252623, 5);
        ...
        Asalariados as2 = new EmpleadoProduccion("Juan de los Zeballos", 25874123, 4, "Noche");
        ...
        EmpleadoDistribucion d1 = new EmpleadoDistribucion("Geral Roque", 85968574, 8, "Norte");
